...
class _SearchPageState extends State<SearchPage> {
  ...
  void searchPlace(String placeName) async {
    ...
    if(placeName.length > 1){
      ...
      String url = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$placeName&key=$mapkey&sessiontoken=123254251&components=country:PAK';
      ...
      body: Column(
        children: <Widget>[
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: 24, top: 38, right: 24, bottom: 20),
              child: Column(
                children: <Widget>[
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset('images/pickup.png', height: 24, width: 24,),
                  ...
                  Row(
                    children: <Widget>[
                      Image.asset('images/destination.png', height: 24, width: 24,),
